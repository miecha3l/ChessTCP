...
void Pawn::findLegalMoves(Board b){
    ...
    if(this->color == "white"){
		...
		if ((board_pos.y - 1 >= 0 && board_pos.x >= 0 && board_pos.x < 8) && b.m_operationalBoard[board_pos.y - 1][board_pos.x - 1] == 1) {
		...
		if ((board_pos.y < 8 && board_pos.x >= 0 && board_pos.x < 8) && b.m_operationalBoard[board_pos.y + 1][board_pos.x - 1] == 2) {
